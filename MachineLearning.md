...
+ **决策树分类**
  ...
  - **Gini系数（CART分类）**
    ...
    A1：$Gini(D,A1=青年)=\cfrac{6}{15}(2\times\cfrac{4}{6}\times\cfrac{2}{6})+\cfrac{9}{15}(2\times\cfrac{2}{9}\times\cfrac{7}{9})=0.39\\  Gini(D,A1=中年)=\cfrac{4}{15}(2\times\cfrac{1}{4}\times\cfrac{3}{4})+\cfrac{11}{15}(2\times\cfrac{5}{11}\times\cfrac{6}{11})=0.46\\  Gini(D,A1=老年)=\cfrac{5}{15}(2\times\cfrac{1}{5}\times\cfrac{4}{5})+\cfrac{10}{15}(2\times\cfrac{5}{10}\times\cfrac{5}{10})=0.11$
    ...
    A4：$Gini(D,A4=一般)=0.36\\ Gini(D,A4=好)=0.47\\ Gini(D,A4=非常好)=0.32$

    ​		非常好为A4的最好划分

    综上，$Gini(D,A1=老年)$为根节点最好划分
